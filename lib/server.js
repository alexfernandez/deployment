...
// constants
var PORT = 3470;
var PATH = '/sm6xrhnmij88qhg1/deploy';
...
function DeploymentServer(options)
{
	...
	if (!options.path)
	{
		log.warning('Using default path %s', PATH);
	}
 ...
 *	- port: the port to use, default 8347.
 *	- path: the only path to accept, for security reasons. See the docs for details.
